...
public class X11Activity extends AppCompatActivity {
    ...
    private List<Double> x11_list = new ArrayList<>();
    private static MainActivity m = new MainActivity();
    private Button x11_back;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_x11);
        x11_back = findViewById(R.id.x11_back);
        x11_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(X11Activity.this, MainActivity.class);
    ...
    private void initData() {
        ...
        for(int i = 0;i < m.DataList.size(); i++){
            x11_list.add(m.DataList.get(i).getX11());
        }
    }
...
//    }
    ...
    private void initLineChart() {
        lineChart = findViewById(R.id.x11_Chart);
    ...
    private void setData() {
        ...
        for(int i = 0;i < x11_list.size(); i++){
            float d = x11_list.get(i).floatValue();
        ...
        dataSet1.setFillColor(Color.YELLOW);
        sets.add(dataSet1);
