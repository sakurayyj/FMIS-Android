...
public class X7Activity extends AppCompatActivity {

    private HorizontalBarChart barChart;
    private List<Double> x7_list = new ArrayList<>();
    private static MainActivity m = new MainActivity();
    private Button x7_back;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_x7);
        x7_back = findViewById(R.id.x7_back);
        x7_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(X7Activity.this, MainActivity.class);
    ...
    private void initBarChart() {
        barChart = findViewById(R.id.x7_Chart);
    ...
    private void setData() {
        ...
        for(int i = 0;i < x7_list.size(); i++){
            float d = x7_list.get(i).floatValue();
            entryList.add(new BarEntry(i,d));
        }

        BarDataSet barDataSet = new BarDataSet(entryList, "");
        barDataSet.setColors(Color.rgb(	250,128,114));
        barDataSet.setValueTextColor(Color.rgb(	176,48,96));
    ...
    private void initData() {
        ...
        for(int i = 0;i < m.DataList.size(); i++){
            x7_list.add(m.DataList.get(i).getX7());
        }
    }
//    private void initData() {
//        x2_list.add(181.54);
