...
public class YActivity extends AppCompatActivity implements OnChartValueSelectedListener {

    private ScatterChart mScatterChart;
    private List<Double> y_list = new ArrayList<>();
    private static MainActivity m = new MainActivity();
    private Button y_back;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_yactivity);
        mScatterChart = findViewById(R.id.y_Chart);
        y_back = findViewById(R.id.y_back);
        y_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(YActivity.this, MainActivity.class);
    ...
    private void initData() {
        ...
        for(int i = 0;i < m.DataList.size(); i++){
            y_list.add(m.DataList.get(i).getY());
        }
    }
//    private void initData() {
//        x4_list.add(7571.0);
...
//    }
    ...
    private void initScatter() {
        //散点图
        mScatterChart = (ScatterChart) findViewById(R.id.y_Chart);
        ...
        //设置y轴升起的动画
        mScatterChart.animateXY(2000,2000);
        //设置点击的高亮
//        mScatterChart.getData().setHighlightEnabled(true);
    ...
    private void setData() {
        ...
        for (int i = 0; i < y_list.size(); i++) {
            ...
            yVals1.add(new Entry(m.DataList.get(i).getYear(), Float.parseFloat(String.valueOf(y_list.get(i)))));
        }
